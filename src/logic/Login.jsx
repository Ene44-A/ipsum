...
const Login = () => {
    ...
    const {isRegister, handleLoginAndRegister, loginWithGoogle, loginWithGithub} = useContext(authContext)
                            ...
                            <div>
                                ...
                                <div className="">
                                    <div className="container-fluid d-flex m-4">
                                        <div className="google-boton col-md-6" >
                                        ...
                                        <div className="google-github col-md-6" >
                                ...
                                <form action="" className='px-5' onSubmit={handleSubmit(login)}>
